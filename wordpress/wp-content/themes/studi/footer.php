<footer>
    ...
    <a href="<?php the_field('facebook', $idOptionsPage ) ?>">
    ...
    <a href="<?php the_field('twitter', $idOptionsPage ) ?>">Twitter</a>
    <a href="<?php the_field('instagram', $idOptionsPage ) ?>">Instagram</a>
    <a href="<?php the_field('linkedin', $idOptionsPage ) ?>">Linkedin</a>
